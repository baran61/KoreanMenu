...
// Tekrarlanan isimleri çıkarmak için fonksiyon
function removeDuplicates(data) {
    return [...new Set(data)]
}
// Tekrarlanan kategori isimlerini temizlemek için fonksiyona gönderiyoruz
let cleanCategories = removeDuplicates(categories);

// All adında yeni bir kategori
